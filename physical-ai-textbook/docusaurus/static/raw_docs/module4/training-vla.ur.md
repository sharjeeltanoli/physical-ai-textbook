...
-   متنوع، اعلیٰ معیار کا روبوٹ مظاہرے کا ڈیٹا جمع کریں۔
-   بیہیویر کلوننگ کو بنیادی ٹریننگ مقصد کے طور پر استعمال کریں۔
-   پیچیدہ کاموں کے لیے Curriculum Learning کا اطلاق کریں۔
-   پری ٹرینڈ ویژن-لینگویج ماڈلز کو فائن ٹیون کریں۔
-   آن لائن فائن ٹیوننگ حقیقی دنیا کی کارکردگی کو بہتر بناتی ہے۔
-   ملٹی ٹاسک ٹریننگ جنرلائزیشن کو بڑھاتی ہے۔

---

**پچھلا:** [VLA Architecture & Theory](./vla-architecture)
**اگلا:** [Deploying VLA for Robotics](./deploying-vla)
