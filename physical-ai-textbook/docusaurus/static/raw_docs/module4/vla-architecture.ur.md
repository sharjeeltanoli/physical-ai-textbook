...
# VLA فن تعمیر اور نظریہ

## Transformer کی بنیاد

### Self-Attention میکانزم
...
- VLA ماڈل Transformer فن تعمیر پر بنائے گئے ہیں
- Vision اور Language کو الگ الگ انکوڈ کیا جاتا ہے پھر فیوز کیا جاتا ہے
- Action کی ڈی کوڈنگ MLP یا Diffusion کے ذریعے
- Behavior Cloning اور Contrastive Learning کے ذریعے تربیت
- Multi-Task Learning تعمیم کو بہتر بناتا ہے
- Data Augmentation مضبوطی کے لیے انتہائی اہم ہے

---

**پچھلا:** [VLA ماڈلز کا تعارف](./intro-vla)
**اگلا:** [VLA ماڈلز کی تربیت](./training-vla)
